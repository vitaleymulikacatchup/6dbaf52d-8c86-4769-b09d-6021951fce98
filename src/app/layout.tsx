...
export const metadata: Metadata = {
  title: "Brew & Bean - Premium Coffee Shop Experience",
  description: "Experience premium coffee at Brew & Bean. Fresh roasted daily, ethically sourced beans, expert baristas. Visit us for the perfect cup of coffee.",
  keywords: "coffee shop, premium coffee, fresh roasted, espresso, cappuccino, latte, coffee beans",
  ...
  openGraph: {
    title: "Brew & Bean - Premium Coffee Shop Experience",
    description: "Experience premium coffee at Brew & Bean. Fresh roasted daily, ethically sourced beans, expert baristas.",
    siteName: "Brew & Bean",
    type: "website",
    images: [{
